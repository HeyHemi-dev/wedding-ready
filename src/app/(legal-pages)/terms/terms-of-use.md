...
- copy, modify, adapt, translate, reverse engineer, decompile, disassemble, or create derivative works from the Service, except to the extent this cannot be restricted under applicable law
- use any automated means (including bots, scrapers, crawlers, or similar tools) to access, extract, download, or index content from the Service without our prior written consent
- attempt to access data you do not have permission to access or to interfere with the proper operation of the Service.
...
- you are authorised to bind the business or entity you act for
- you will use the Service only for lawful business purposes and in accordance with these Terms and our policies
- all information you provide about your services, pricing, and availability is accurate, up to date, and not misleading
...
- scrape, harvest, or collect information from Wedding Ready (including supplier information or contact details) for any purpose that is unrelated to planning or delivering a wedding or related event
- bulk-download images or other content from the Service
- use the Service to send unsolicited commercial messages or spam
- attempt to bypass or interfere with any security, rate-limiting, or access controls that we apply
...
- you will only upload or post User Content that you have the necessary rights and permissions to use and share
- you will not post User Content that infringes or violates any third-party rights, including copyright, trade mark, privacy, or publicity rights
- you have obtained all necessary permissions and consents from any person who appears in your User Content (including from a parent or legal guardian for any person under 18)
...
- use, host, store, reproduce, modify, adapt, edit, reformat, translate, create derivative works from, publicly perform, publicly display, make available and otherwise communicate, and distribute your User Content
- use your User Content to operate, maintain, and improve the Service
- use your User Content to promote Wedding Ready, including in our marketing, communications, and case studies.
...
- copies may remain in our systems for a reasonable period of time for backup, archival, or audit purposes, and
- we may continue to use your User Content in any materials already created (for example, promotional materials or campaigns that are already in circulation) under a continuing, non-revocable licence for those specific uses.
...
- view, save, or share your User Content
- organise it into collections or mood boards
- click through to your supplier profile or external website.
...
### Supplier-specific responsibilities

If you are a supplier, you must:

- only upload content that you own or have a valid licence to use for promotional purposes
- ensure that credits and attributions (for example, to photographers, stylists, venues, and other suppliers) are accurate and not misleading
- promptly correct or remove any User Content that you discover is inaccurate, misleading, or infringing
- comply with all advertising, consumer, and fair trading laws that apply to your business
- ensure that any “before and after” or other comparative content you post is honest, not misleading, and accurately represents your services.
...
- saved by other users into their collections or boards, or
- incorporated into materials that have already been created or published.
...
- we may use, adapt, and implement your Feedback for any purpose, including improving the Service, without any payment or compensation to you
- we do not waive any rights to use similar ideas that we already knew about, developed ourselves, or obtained from other sources.

### Reporting content and moderation
...
- unlawful
- infringing your intellectual property rights or privacy rights
- abusive, hateful, harmful, or otherwise contrary to these Terms.

When we receive a report, we will review it and take whatever action we consider appropriate, which may include:

- asking the user to modify or remove the content
- hiding, restricting, or removing the content ourselves
- suspending or terminating the relevant account in serious or repeated cases
- where required by law, reporting the matter to relevant authorities.
...
- designs, branding, logos, and trade marks
- layouts, user interfaces, and features
- text, graphics, and other content we create.
...
- notify us promptly if you become aware of any unauthorised access to your account or any other breach of security.
...
- the content, products, or services provided by third parties, or
...
- your use of the Service is causing or is likely to cause harm to us, other users, or third parties
...
- you have the right and authority to enter into these Terms and to use the Service
- you have all rights, licences, permissions, and consents necessary to upload and use your User Content on Wedding Ready as described in these Terms
- your User Content and your use of the Service will comply with these Terms and with all applicable laws (including, for suppliers, consumer protection and fair trading laws).
...
- your User Content, including any allegation that it infringes or violates the rights of a third party
...
- suitable for your particular purposes.

We do not control and are not responsible for the actions or omissions of users or suppliers, including:

- the accuracy of supplier listings, pricing, or availability
- the quality of any goods or services provided by suppliers
- any arrangements, agreements, or disputes between couples and suppliers.
...
- any loss of profit, revenue, goodwill, or opportunity
- any loss of data, including loss of User Content
- any indirect, consequential, or special loss or damage
- any loss or damage resulting from:
    - your use of, or inability to use, the Service
    - any conduct or content of any other user or third party on the Service
    - unauthorised access to or use of your account or information, where we have taken reasonable security steps.
...
- the total fees (if any) you have paid to us for use of the Service in the 12 months immediately before the event giving rise to the claim, or
- NZD $100.
...
- a description of the work or material you claim is infringed
- a description of the content on Wedding Ready that you claim is infringing, including a link or other information reasonably sufficient for us to locate it
- a statement that you genuinely believe, on reasonable grounds, that the use of the content is not authorised by you, your agent, or the law
- a statement that the information you have provided is accurate and that you are the rights holder or are authorised to act on behalf of the rights holder.
...
- personalise your experience and show you relevant content and suppliers
