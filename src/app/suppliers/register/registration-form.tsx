...
import { HandleStatus, status } from '@/src/app/_types/handle-available-status'
import { SupplierRegistrationForm, supplierRegistrationFormSchema } from '@/src/app/_types/validation-schema'
import type { HandleGetResponseBody } from '@/src/app/api/suppliers/check-handle/[handle]/route'
                      ...
                      render={({ field }) => {
                        return (
                          <FormItem key={location.value} className="flex flex-row items-center gap-partner">
                            ...
                            <FormLabel className="text-foreground">{location.label}</FormLabel>
                          </FormItem>
                        )
                      }}
                    />
                      ...
                      render={({ field }) => {
                        return (
                          <FormItem key={service.value} className="flex flex-row items-center gap-partner">
                            ...
                            <FormLabel className="text-foreground">{service.label}</FormLabel>
                          </FormItem>
                        )
                      }}
                    />
