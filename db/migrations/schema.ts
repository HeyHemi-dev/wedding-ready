...
export const locations = pgEnum("locations", ['northland', 'auckland', 'waikato', 'bay_of_plenty', 'gisborne', 'hawkes_bay', 'taranakai', 'manawatu_whanganui', 'wellington', 'nelson_tasman', 'marlborough', 'west_coast', 'canterbury', 'otago', 'southland'])
export const services = pgEnum("services", ['venue', 'accomodation', 'caterer', 'cake', 'photographer', 'videographer', 'bridal_wear', 'bridesmaids_wear', 'bridal_accessory', 'menswear', 'menswear_accessory', 'rings', 'makeup', 'hair', 'beauty', 'planner', 'celebrant', 'mc', 'florist', 'stylist', 'hire', 'stationery', 'band', 'entertainment', 'transport', 'support'])
...
export const stackTiles = pgTable("stack_tiles", {
...
export const savedTiles = pgTable("saved_tiles", {
...
export const tileSuppliers = pgTable("tile_suppliers", {
	tileId: uuid("tile_id").notNull(),
	supplierId: uuid("supplier_id").notNull(),
	service: services(),
