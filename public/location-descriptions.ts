...
const locationDescriptions = {
  ...
  [Location.BAY_OF_PLENTY]: {
    title: 'Weddings in Bay of Plenty',
    description:
  ...
  [Location.MANAWATU_WHANGANUI]: {
    title: 'Weddings in Manawatū–Whanganui',
    description:
  ...
  [Location.NELSON_TASMAN]: {
    title: 'Weddings in Nelson–Tasman',
    description:
