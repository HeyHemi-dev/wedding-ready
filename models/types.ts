...
export type SetUserDetailRaw = Omit<InsertUserDetailRaw, 'id' | 'createdAt'>
...
export type SetSupplierRaw = Omit<InsertSupplierRaw, 'id' | 'createdAt' | 'createdByUserId'>
...
export type SetStackRaw = Omit<InsertStackRaw, 'id' | 'createdAt' | 'ownedByUserId'>
...
export type SetSupplierUserRaw = Omit<InsertSupplierUserRaw, 'supplierId' | 'userId'>
...
export type SetSupplierServiceRaw = Omit<InsertSupplierServiceRaw, 'supplierId' | 'service'>
...
export type SetSupplierLocationRaw = Omit<InsertSupplierLocationRaw, 'supplierId' | 'location'>
...
export type SetSavedTileRaw = Omit<InsertSavedTileRaw, 'userId' | 'tileId'>
...
export type SetTileSupplierRaw = Omit<InsertTileSupplierRaw, 'tileId' | 'supplierId'>
...
export type SetStackTileRaw = Omit<InsertStackTileRaw, 'stackId' | 'tileId'>
